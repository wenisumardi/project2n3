...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="{{ url('/home')}}"><img src="themes/images/logo.png" alt="Bootsshop"/></a>
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <li class="">
	 <a href="{{ url('/login')}}" role="button" data-toggle="modal" style="padding-right:0"><span class="btn btn-large btn-success">Login</span></a>
